...
namespace FalloutBatchMaker
{
    public partial class MainForm : Form
    {
        ...
        private IList<JObject> master_values;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string json_file = System.IO.File.ReadAllText(fd.FileName);
                ...
                if (parsed_json["Game"].Value<string>() == "Fallout 4")
                {
                    ...
                    {
                        foreach (JObject child in parsed_json.Children().Last())
                        {
                            child.Add("itemCategory", category_name);

                            //master_values.Add(JArray.Parse(child.ToString()));
                        }
                        //DataTable dt = populateTable(master_values);
                        //createTab(category_name, dt);
                        master_values.Clear();
        ...
        private DataTable populateTable(JArray values)
        {
            DataTable dt = new DataTable();
        ...
        private void createTab(string category, DataTable dt)
        {
            ...
            ToolStripLabel tsl1c = new ToolStripLabel("100");
            ...
            ToolStripButton tsbtn = new ToolStripButton("Search");
            tsbtn.Name = category + " search_btn";
            tsbtn.Alignment = ToolStripItemAlignment.Right;
